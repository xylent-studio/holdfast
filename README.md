...
- `.github/workflows/hosted-validation.yml` can run staged and production hosted auth/sync smoke on GitHub Actions when the required secrets are configured
