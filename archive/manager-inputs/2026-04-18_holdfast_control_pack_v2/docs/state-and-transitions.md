...
This conversion should feel natural and should preserve context.
...
- Today -> Waiting on
- Today -> Archived
- Today -> Inbox only if there is a good product reason, not because the state model is weak

- Upcoming -> Today
- Upcoming -> Waiting on
- Upcoming -> Archived
- Upcoming -> Done if the completion makes sense without first surfacing in Today
...
- Done -> Today only as an intentional reopen action
...
- Today -> Inbox or Upcoming if it should remain visible elsewhere
- Today -> Archived
